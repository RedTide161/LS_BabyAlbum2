...
public class PageTransformerAdapter implements ViewPager.PageTransformer {

    private List<ParallaxTransformInformation> mViewsToParallax = new ArrayList<ParallaxTransformInformation>();

    public PageTransformerAdapter() {
    }

    public PageTransformerAdapter(@NotNull List<ParallaxTransformInformation> viewsToParallax) {
        mViewsToParallax = viewsToParallax;
    }

    public PageTransformerAdapter addViewToParallax(@NotNull ParallaxTransformInformation viewInfo) {
