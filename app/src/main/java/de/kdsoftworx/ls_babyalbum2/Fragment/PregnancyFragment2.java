...
public class PregnancyFragment2 extends Fragment {

    private BookdataViewModel bookdataViewModel;

    ImageView P_image1, P_image2, P_image3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        bookdataViewModel.getAllBookdataEntries().observe(getViewLifecycleOwner(), new Observer<List<LSBookdata>>() {
            ...
            public void onChanged(List<LSBookdata> lsBookdata) {
                ...
                if (lsBookdata.size() >0) {
                    ...
                    if (currentData.P_image1 != null) {
                        // get Path of Image from Database
                        String pathImage1 = currentData.P_image1;
                        // Load File
                    ...
                    if (currentData.P_image2 != null) {
                        // get Path of Image from Database
                        String pathImage2 = currentData.P_image2;
                        // Load File
                    ...
                    if (currentData.P_image3 != null) {
                        // get Path of Image from Database
                        String pathImage3 = currentData.P_image3;
                        // Load File
        ...
        P_image1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // Check if ImageView was Clicked to set a Image
        P_image2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check Permission for reading Storage
                if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) + ActivityCompat.checkSelfPermission(getActivity(), WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
        ...
        // Check if ImageView was Clicked to set a Image
        P_image3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check Permission for reading Storage
                if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) + ActivityCompat.checkSelfPermission(getActivity(), WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case 31: // Load Picture in Cropper
                    ...
                    startActivityForResult(intentIV1, 34);
                    Log.d(Log_tag, "Loaded Picture from Cropper to Imageview 1 in Pregnancy Fragment");
                    break;


                case 32: // Load Picture in Cropper
                    Uri picUri2 = data.getData();

                    Intent intentIV2 = CropImage.activity(picUri2)
                            //Customize Cropper
                            .setCropMenuCropButtonIcon(R.drawable.crop_icon).setAspectRatio(1,1).setActivityMenuIconColor(R.color.colorPrimaryDark).getIntent(getContext());
                    startActivityForResult(intentIV2, 35);
                    Log.d(Log_tag, "Loaded Picture from Cropper to Imageview 2 in Pregnancy Fragment");
                    break;

                case 33: // Load Picture in Cropper
                    Uri picUri3 = data.getData();

                    Intent intentIV3 = CropImage.activity(picUri3)
                            //Customize Cropper
                            .setCropMenuCropButtonIcon(R.drawable.crop_icon).setAspectRatio(1,1).setActivityMenuIconColor(R.color.colorPrimaryDark).getIntent(getContext());
                    startActivityForResult(intentIV3, 36);
                    Log.d(Log_tag, "Loaded Picture from Cropper to Imageview 3 in Pregnancy Fragment");
                    break;

                case 34: // Add Picture to ImageView 1
                    ...
                    if (resultCode == RESULT_OK) {
                        ...
                        try {
                            ...
                            String imagePath = imageHandler.saveImageAsync("P_image1_" + userLokalStore.getCurrentRecordId(), bitmapImage1);
                            ...
                            P_image1.setImageBitmap(bitmapImage1);
                ...
                case 35: // Add Picture to ImageView 2
                    ...
                    if (resultCode == RESULT_OK) {
                        ...
                        try {
                            ...
                            // Get Image and pass it to ImageHandler to Store Image in Directory
                            ImageHandler imageHandler = ImageHandler.getInstance();
                            String imagePath = imageHandler.saveImageAsync("P_image2_"+ userLokalStore.getCurrentRecordId(), bitmapImage2);

                            // Create a Query for storing image in Database
                            SimpleSQLiteQuery query = new SimpleSQLiteQuery("UPDATE " + getString(R.string.tableName) + " " +
                                    "SET P_image2 = '"+ imagePath  +
                                    "' WHERE customer_id = " + userLokalStore.getLoggedInUser().getUserId() + " AND id = " + userLokalStore.getCurrentRecordId());
                            // Store Image in Database
                            bookdataViewModel.update(query);

                            // Load Image to imageView
                            P_image2.setImageBitmap(bitmapImage2);
                ...
                case 36: // Add Picture to ImageView 3
                    ...
                    if (resultCode == RESULT_OK) {
                        ...
                        try {
                            ...
                            // Get Image and pass it to ImageHandler to Store Image in Directory
                            ImageHandler imageHandler = ImageHandler.getInstance();
                            String imagePath = imageHandler.saveImageAsync("P_image3_" + userLokalStore.getCurrentRecordId() , bitmapImage3);

                            // Create a Query for storing image in Database
                            SimpleSQLiteQuery query = new SimpleSQLiteQuery("UPDATE " + getString(R.string.tableName) + " " +
                                    "SET P_image3 = '"+ imagePath  +
                                    "' WHERE customer_id = " + userLokalStore.getLoggedInUser().getUserId() + " AND id = " + userLokalStore.getCurrentRecordId());
                            // Store Image in Database
                            bookdataViewModel.update(query);

                            // Load Image to imageView
                            P_image3.setImageBitmap(bitmapImage3);
    ...
    {
        P_image1 = view.findViewById(R.id.iv_p_mom_1);
        P_image2 = view.findViewById(R.id.iv_p_mom_2);
        P_image3 = view.findViewById(R.id.iv_p_ultrasound_pic);
    }
