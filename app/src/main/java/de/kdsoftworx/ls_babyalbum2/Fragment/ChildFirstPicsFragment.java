...
public class ChildFirstPicsFragment extends Fragment {

    // Declarations
    private BookdataViewModel bookdataViewModel;

    ImageView FI_image1, FI_image2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_cbd_pics, container, false);
        root.getTag();
        ...
        bookdataViewModel.getAllBookdataEntries().observe(this, new Observer<List<LSBookdata>>() {
            ...
            public void onChanged(List<LSBookdata> lsBookdata) {
                ...
                if (lsBookdata.size() >0) {
                    ...
                    if (currentData.FI_image1 != null) {
                        // get Path of Image from Database
                        String pathImage1 = currentData.FI_image1;
                        // Load File
                    ...
                    if (currentData.FI_image2 != null) {
                        // get Path of Image from Database
                        String pathImage2 = currentData.FI_image2;
                        // Load File
        ...
        FI_image1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        FI_image2 = (ImageView) root.findViewById(R.id.iv_cbd_fi_with_mum);
        FI_image2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check Permission for reading Storage
                if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) + ActivityCompat.checkSelfPermission(getActivity(), WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case 1: // Load Picture in Cropper
                    ...
                    startActivityForResult(intentIV1, 3);
                    Log.d(Log_tag, "Loaded Picture from Cropper to Imageview 1");
                    break;


                case 2: // Load Picture in Cropper
                    Uri picUri2 = data.getData();

                    Intent intentIV2 = CropImage.activity(picUri2)
                            //Customize Cropper
                            .setCropMenuCropButtonIcon(R.drawable.crop_icon).setAspectRatio(1,1).setActivityMenuIconColor(R.color.colorPrimaryDark).getIntent(getContext());
                    startActivityForResult(intentIV2, 4);
                    Log.d(Log_tag, "Loaded Picture from Cropper to Imageview 2");
                    break;


                case 3: // Add Picture to ImageView 1
                    ...
                    if (resultCode == RESULT_OK) {
                        ...
                        try {
                            ...
                            String imagePath = imageHandler.saveImageAsync("FI_image1_" + userLokalStore.getCurrentRecordId(), bitmapImage1);
                            ...
                            FI_image1.setImageBitmap(bitmapImage1);
                ...
                case 4: // Add Picture to ImageView 2
                    ...
                    if (resultCode == RESULT_OK) {
                        ...
                        try {
                            ...
                            // Get Image and pass it to ImageHandler to Store Image in Directory
                            ImageHandler imageHandler = ImageHandler.getInstance();
                            String imagePath = imageHandler.saveImageAsync("FI_image2_" + userLokalStore.getCurrentRecordId(), bitmapImage2);

                            // Create a Query for storing image in Database
                            SimpleSQLiteQuery query = new SimpleSQLiteQuery("UPDATE " + getString(R.string.tableName) + " " +
                                    "SET FI_image2 = '"+ imagePath  +
                                    "' WHERE customer_id = " + userLokalStore.getLoggedInUser().getUserId() + " AND id = " + userLokalStore.getCurrentRecordId());
                            // Store Image in Database
                            bookdataViewModel.update(query);

                            // Load Image to imageView
                            FI_image2.setImageBitmap(bitmapImage2);
    ...
    {
        FI_image1 = view.findViewById(R.id.iv_cbd_fi_baby);
        FI_image2 = view.findViewById(R.id.iv_cbd_fi_with_mum);
    }
