...
public class FirstStepsFragment1 extends Fragment {
    ...
    EditText FST_inputText1, FST_inputText2, FST_inputText3, FST_inputText4, FST_inputText5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_first_steps_1, container, false);

        // inittialise all editTexts
        init(root);
        ...
        bookdataViewModel.getAllBookdataEntries().observe(this, new Observer<List<LSBookdata>>() {
            ...
            public void onChanged(List<LSBookdata> lsBookdata) {
                ...
                if (lsBookdata.size() >0) {
                    ...
                    FST_inputText1.setText(currentData.FST_inputText1);
                    FST_inputText2.setText(currentData.FST_inputText2);
                    FST_inputText3.setText(currentData.FST_inputText3);
                    FST_inputText4.setText(currentData.FST_inputText4);
                    FST_inputText5.setText(currentData.FST_inputText5);
                }
            }
        });
    ...
    private void storeDataToDatabase ()
    {
        ...
        SimpleSQLiteQuery query = new SimpleSQLiteQuery("UPDATE " + getString(R.string.tableName) + " " +
                "SET FST_inputText1 = '"+ FST_inputText1.getText().toString()+ "'" +
                ", FST_inputText2 = '"+ FST_inputText2.getText().toString()+ "'" +
                ", FST_inputText3 = '"+ FST_inputText3.getText().toString()+ "'" +
                ", FST_inputText4 = '"+ FST_inputText4.getText().toString()+ "'" +
                ", FST_inputText5 = '"+ FST_inputText5.getText().toString() +
    ...
    {
        FST_inputText1 = view.findViewById(R.id.et_fst_textInput_1);
        FST_inputText2 = view.findViewById(R.id.et_fst_textInput_2);
        FST_inputText3 = view.findViewById(R.id.et_fst_textInput_3);
        FST_inputText4 = view.findViewById(R.id.et_fst_textInput_4);
        FST_inputText5 = view.findViewById(R.id.et_fst_textInput_5);
    }
